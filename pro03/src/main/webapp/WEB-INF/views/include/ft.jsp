...
<!-- 푸터 내용 기술 -->
    <div class="ft-wrap">
    	...
    	<hr style="background-color:#235c34; height:3px; margin:0px auto; padding:0px; ">
        <div class="footer container clr-fix">
            <p class="copyright">
				<span class="ft_col">법인명 : (주)VT</span> <span class="ft_col">대표자 : 조우진</span> 
				...
				<span class="ft_col">개인정보관리책임자: <strong><a href="mailto:admin@morningoffice.co.kr" title="관리자에게 메일 보내기">관리자(admin@vtoffice.co.kr)</a></strong></span>
